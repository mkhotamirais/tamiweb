...
export default function RequestClientDialog() {
  return (
    <Dialog>
      <Button asChild title="request client" size={"icon"} className="fixed bg-black/30 right-4 bottom-4 rounded-full">
        <DialogTrigger>
          <NotepadText />
        </DialogTrigger>
      </Button>
      <DialogContent className="max-h-[calc(100vh-4rem)] max-w-3xl overflow-y-scroll">
        <DialogHeader>
          ...
          <DialogDescription>This is request client model generated by chatgpt</DialogDescription>
          <div className="px-3 py-8 md:px-8 max-w-3xl mx-auto my-8 bg-white dark:bg-gray-950 shadow-lg leading-relaxed">
            ...
            <div>
              ...
              We would appreciate it if you could provide us with a detailed proposal, including the estimated timeline
              and cost for the project. If you need any further information or would like to schedule a meeting, please
              feel free to contact me at ahmad.rafi@bluefieldhigh.edu.
              <br />
